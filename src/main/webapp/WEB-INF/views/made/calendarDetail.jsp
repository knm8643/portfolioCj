...
<form action="delete" method="get">
 <div class="mainBox">
    <div class="main_wrap">
	   <div class="main_head">
		  <div class="navi">
			<h3>${list.club }메인테마제목이 나옵니다!</h3>
		  </div>
		  <div class="calendar_list">
            <span>${list.day_start }스케줄 시작날짜가 보여집니다! 하지만 지금 서버구현은 안했습니다!</span>
	   ...
	   <div class="main_body">
          <div class="title">
              <span>제목 : 입력한 제목이 나옵니다!</span><span> ${list.title } </span>
		  </div>
          <div class="title">
              <span>참여자 : 클릭시 참여자를 등록할수있습니다</span>
          ...
          <div class="title">
              <span>설명 : 클릭시 설명을 추가할 수 있습니다!</span>
